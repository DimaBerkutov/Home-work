...
// listOfCompanys.forEach(function(elem, index, listOfCompanys){
//   if(elem.index % 2 == 0){
//     console.log('company:', elem.company, 'age: ', elem.age);
//   }

// });

// listOfCompanys.filter(function(elem, index, listOfCompanys){
//     return elem.age > 22;
// });
// console.log('listOfCompanys:', listOfCompanys);
...
// let allNames = megaObject.friends.every(function(elem, index, listOfCompanys){
//   console.log('friends:', elem);
//   if(elem.name.split(' ')[0].length => 1){
//     return true;
//   }
//     return false;
// });
...
// let arr = [10, 20, 30, 40];
// let arr2 = arr.map(function(elem, index, listOfCompanys){
//   console.log('friends:', elem);
//     return { name: 'Some name', age: elem};
// });
// console.log(arr2);
...
// let friends = listOfCompanys.map(function(elem, index, listOfCompanys){
//   let newObj = megaObject.friends[index];
//   newObj.company = megaObject.friends[index].id;
//   return newObj;
// });
...
let newArray = arr.map(function(elem, index, arr){
  return {oldValue: elem, newValue: elem * 2};
});
console.log('elem', newArray);